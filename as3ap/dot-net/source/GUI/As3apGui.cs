...
{		
	public class As3apGui : System.Windows.Forms.Form 
	{
		...
		private void InitializeComponent() 
		{
			...
			// chkHashIndexes
			// 
			this.chkHashIndexes.Location = new System.Drawing.Point(184, 8);
			...
			// chkClusterIndexes
			// 
			this.chkClusterIndexes.Location = new System.Drawing.Point(8, 8);
		...
		private void updateControls()
		{
			...
			switch (this.configuration.HelperType)
			{
				...
				case DataHelperType.OracleClient:
					this.cboHelperType.SelectedItem = this.cboHelperType.Items[1];
					break;

				case DataHelperType.PgSqlClient:
					this.cboHelperType.SelectedItem = this.cboHelperType.Items[2];
					break;
				
				case DataHelperType.SqlClient:
					this.cboHelperType.SelectedItem = this.cboHelperType.Items[3];
					break;
			}
